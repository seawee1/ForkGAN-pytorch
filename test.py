...
if __name__ == '__main__':
    ...
    if opt.dataset_mode == 'unaligned_coco':
        ...
        for i, data in enumerate(dataset):
            ...
            if os.path.isfile(os.path.join(opt.results_dir, img_path)):
            ...
            save_images_dataset(opt.results_dir, visuals, img_path, aspect_ratio=opt.aspect_ratio, width=opt.display_winsize)
    else:
        # create a website
